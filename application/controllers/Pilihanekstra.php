...
class Pilihanekstra extends MY_Controller
{
...
//}
    ...
    public function index()
    {
        ...
        $data['page_part'] = 'pilihanekstra/list_pilihan_ekstra';
        $data['js_part'] = array(
            "features/js/js_socket",
            "features/js/js_form",
            'features/js/js_grid_item',
            'features/js/js_datatable', 
            'features/js/js_pilihan_ekstra',
    ...
    public function itemform()
    {
        ...
        $data['selected_outlet'] = $this->nutaquery->getOutlet();
        $data['page_part'] = 'pilihanekstra/form_pilihan_ekstra';
        $data['js_part'] = array(
            'features/js/js_socket',
