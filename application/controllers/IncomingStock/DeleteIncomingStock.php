...
trait DeleteIncomingStock
{
    public function destroy($dateStart, $dateEnd)
    {
        ...
        return redirect(base_url('stokmasuk/?outlet=' . $this->getWhere()['DeviceID'] . '&ds=' . $dateStart . '&de=' . $dateEnd));
    }
    ...
    protected function runDeleteValidation()
    {
        ...
        ($this->form_validation->run()) ?: redirect('/stokmasuk/?outlet=' . $this->input->post('outlet_id'));
