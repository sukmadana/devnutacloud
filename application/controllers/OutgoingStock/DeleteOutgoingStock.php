...
trait DeleteOutgoingStock
{
    public function destroy($dateStart, $dateEnd)
    {
        ...
        return redirect(base_url('stokkeluar/?outlet=' . $this->getWhere()['DeviceID'] . '&ds=' . $dateStart . '&de=' . $dateEnd));
    }
    ...
    protected function runDeleteValidation()
    {
        ...
        ($this->form_validation->run()) ?: redirect('/stokkeluar/?outlet=' . $this->input->post('outlet_id'));
