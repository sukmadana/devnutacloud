...
class Item extends MY_Controller
{
    ...
    public function itemform()
    {
        ...
        if ($mode == 'edit') {
            ...
            $kategoridevno = $item->CategoryDeviceNo;
        ...
        $data['form']['kategoridevno'] = $kategoridevno;
        ...
        $data['selected_outlet'] = $this->nutaquery->getOutlet();
        $data['page_part'] = 'item/form_master_item';
        $data['js_part'] = array(
            'features/js/js_socket',
