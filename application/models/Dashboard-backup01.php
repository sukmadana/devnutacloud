...
WHERE selected_date between '" . $days[0]['tahun'] . "-" . $days[0]['bulan'] . "-" . $days[0]['tanggal'] . "' AND '" .
        ...
        $sqlQuery = "
select v.selected_date as Tanggal, COALESCE(SUM(Total+Rounding),0) Total from 
...
LEFT JOIN sale s ON STR_TO_DATE(s.SaleDate, '%Y-%m-%d')=v.selected_date AND Pending = 'false' " . $ConditionMore .
            $whereDate . "
