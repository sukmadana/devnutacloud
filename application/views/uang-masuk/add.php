<div class="row">
    <div class="col-md-6">
        <br/><a href="<?= base_url() ?>uangmasuk/?outlet=<?= $_GET['outlet'] ?>&ds=<?= $date_start ?>&de=<?= $date_end ?>" class="btn btn-default">Kembali</a>
    </div>
    <div class="col-md-6">
                        ...
                        <form class="form-horizontal form-store" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="radio" style="display: inline-block !important">
                                        <label>
                                            <input type="radio" name="jenis" value="1" checked>Pendapatan Lain
                                        </label>
                                    </div>
                                    <div class="radio" style="display: inline-block !important;margin-left:15px;">
                                        <label>
                                            <input type="radio" name="jenis" value="2">Non Pendapatan
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-actions text-right">
                                    <a href="<?= base_url() ?>uangmasuk/?outlet=<?= $_GET['outlet'] ?>&ds=<?= $date_start ?>&de=<?= $date_end ?>"
