    ...
    <div class="col-md-12">
        <div class="box-widget widget-module">
            <div class="widget-head clearfix">
                ...
                <h4>Laporan Mutasi Kas / Rekening</h4>
            ...
            <div class="widget-container">
                <div class=" widget-block">
                    <?php $this->load->view('features/filters/filter_form_mutasi_kas_rekening'); ?>
                    <hr/>
                                    ...
                                    <tr>
                                        <?php foreach ($datagrid['fields'] as $field) { ?>
                                            <td>
                                                ...
                                                if(strpos($lowerfieldname,'saldo') !== FALSE || strpos($lowerfieldname,'masuk') !== FALSE || strpos($lowerfieldname,'keluar') !== FALSE){
                                                 echo "Rp. ". $this->currencyformatter->format($row->$fieldname);
                                                }else {
                                                    if ($row->$fieldname == 'Stok Awal') {
                                                        echo "Saldo Awal";
                                                    } else {
                                                        echo $row->$fieldname;
                                                    }
