...
$str .= '<th>Total Qty per Tipe</th>';
$str .= '<th>Total Rp per Tipe</th>';
$str .= '<th>Total Markup per Tipe</th>';
        $str .= '</tr>
    </thead>
    <tbody>';
    $str .= $tbody;
...
$str_export .= '<th>Total Qty per Tipe</th>';
$str_export .= '<th>Total Rp per Tipe</th>';
$str_export .= '<th>Total Markup per Tipe</th>';
        $str_export .= '</tr>
    </thead>
    <tbody>';
