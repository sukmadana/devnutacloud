                                        ...
                                        <?php foreach ($datagrid['fields'] as $field) { ?>
                                            <td>
                                                ...
                                                if(strpos($lowerfieldname,'total') !== FALSE){
                                                    ...
                                                    if (array_key_exists($row->$fieldname, $datagrid['links'])) {
                                                        echo '<a target="_blank" class="btn btn-primary btn-sm" href="' . base_url() . $datagrid['links'][$row->$fieldname] . '?' . $_SERVER['QUERY_STRING'] . '" role="button">' . $row->$fieldname . '</a>';
                                                    } else {
                                                        echo $row->$fieldname;
                                                    }
                                                }
