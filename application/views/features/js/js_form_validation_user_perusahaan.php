                ...
                .bootstrapValidator({
                    ...
                    fields: {
                        username: {
                            ...
                            validators: {
                                "remote": {
                                    url: '<?= base_url() . 'ajax/validateusername'; ?>',
                                    type: "post",
                                    data: {
                                        username: function() {
                        ...
                        email: {
                            validators: {
                                "remote": {
                                    url: '<?= base_url() . 'ajax/validateemail'; ?>',
                                    type: "post",
                                    data: {
                                        email: function() {
                ...
                .bootstrapValidator({
                    ...
                    fields: {
                        username: {
                            ...
                            validators: {
                                "remote": {
                                    url: '<?= base_url() . 'ajax/validateusernameedit'; ?>',
                                    type: "post",
                                    data: {
                                        selectedusername: function() {
                                            return $('#form-edit-user-perusahaan :input[name="selecteduser"]').val();
                                        },
                                        username: function() {
                                            return $('#form-edit-user-perusahaan :input[name="username"]').val();
                                        }
                                    },
                                    message: 'Username sudah dipakai.'
                                },
                        ...
                        email: {
                            validators: {
                                "remote": {
                                    url: '<?= base_url() . 'ajax/validateemailedit'; ?>',
                                    type: "post",
                                    data: {
                                        selectedusername: function() {
                                            return $('#form-edit-user-perusahaan :input[name="selecteduser"]').val();
                                        ...
                                        email: function() {
                                            return $('#form-edit-user-perusahaan :input[name="email"]').val();
                                        }
                                    },
                                    message: 'Email sudah dipakai.'
                                },
                    ...
                    $('#form-edit-user-perusahaan').bootstrapValidator('defaultSubmit');
                });
        }
    });
</script>