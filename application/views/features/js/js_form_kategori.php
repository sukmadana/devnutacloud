...
?>
<script src="<?= base_url('js/nutalibs/item.js'); ?>" type="text/javascript"></script>
<script type="text/javascript">
    ...
    function goSavingItem(bunchOfPilihanEkstra, masterItemPostData) {
        ...
        itemFormSaver.saveItem('<?=$modeform == 'new' ? base_url('ajax/createnewkategori') : base_url('ajax/editkategori');?>', masterItemPostData).then(function (arrayOfSavedItemID) {
//            var ids = [];
//            var outlets = [];
...
//                }
//            }
            saveItemFinished('Kategori berhasil disimpan');
        }).catch(function (error) {
            console.log('Terjadi Kesalahan : ' + error);
            saveItemFinished('Kategori gagal disimpan. Terjadi Kesalahan : ' + error)
        });
    }
...
//                console.log(response);
        ...
        $('#outlet').change(function () {
            window.location = '<?=$modeform == 'edit' ? base_url("kategori/itemform") . "?id=" . urlencode($form['nama item']) . "&outlet="
                    : base_url("kategori/itemform") . "?outlet=";?>' + $(this).val();
        });
