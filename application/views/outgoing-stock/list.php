                ...
                <div class="page-breadcrumb-wrap" style="width: 100%">
                    <div class="page-breadcrumb-info">
                        <form class="form-horizontal pull-right" method="get"
                              id="form-add" action="<?= base_url() ?>stokkeluar/add">
                            <?php if (getLoggedInNamaPerusahaan() != "Individual") { ?>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <input type="button" value="Tambah Stok Keluar"
...
<div class="row">
    <div class="col-md-12">
        <?php if ($selected_outlet): ?>
            ...
            <form action="<?= base_url("stokkeluar/?outlet=" . $selected_outlet) ?>" method="post" id="filter-date"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($visibilityMenu['StockEdit']) { ?>
                                                    <a href="<?php echo base_url("stokkeluar/edit/" . $selected_outlet . "/" . $stok->TransactionID . "." . $stok->DeviceNo . "?ds=" . $date_start . "&de=" . $date_end); ?>"
                                                       class="btn btn-default">Edit</a>
                                                <?php } ?>
                                                <a href="<?php echo base_url("stokkeluar/view/" . $selected_outlet . "/" . $stok->TransactionID . "." . $stok->DeviceNo . "?ds=" . $date_start . "&de=" . $date_end); ?>"
                                                ...
                                                <?php } ?>
                                                <form action="<?= base_url('stokkeluar/destroy/' . urlencode($date_start) . "/" . urlencode($date_end)) ?>"
