<div class="row">
    <div class="col-md-6">
        <br/><a href="<?= base_url() ?>stokkeluar/?outlet=<?= $_GET['outlet'] ?>&ds=<?= $date_start ?>&de=<?= $date_end ?>" class="btn btn-default">Kembali</a>
    </div>
    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-actions text-right">
                                        <a href="<?= base_url() ?>stokkeluar/?outlet=<?= $_GET['outlet'] ?>&ds=<?= $date_start ?>&de=<?= $date_end ?>"
