...
<div class="row">
    <div class="col-md-6">
        <br/><a href="<?= base_url() ?>stokkeluar/?outlet=<?= $koreksi_stok->DeviceID; ?>&ds=<?= $date_start ?>&de=<?= $date_end ?>" class="btn btn-default">Kembali</a>
    </div>
    <div class="col-md-12">
                ...
                <div class="widget-container">
                    <div class="widget-block">
                        <form class="form-horizontal form-store" method="post"
                              action="<?php echo base_url(); ?>stokkeluar/simpan">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-actions text-right">
                                        <a href="<?= base_url() ?>stokkeluar/?outlet=<?= $koreksi_stok->DeviceID ?>&ds=<?= $date_start ?>&de=<?= $date_end ?>"
