                        ...
                        <table class="table table-bordered  table-striped " id="grid-item">
                            ...
                            <tr>
                                <?php foreach ($datagrid['fields'] as $field) {
                                    ...
                                    if ($lowerfieldname == 'itemid' || $lowerfieldname == 'deviceno') {
                                        continue;
                                    }
                                    if ($field->name === "Foto") {
                                        ?>
                            ...
                            <tr>
                                <?php foreach ($datagrid['fields'] as $field) { ?>
                                    ...
                                    <?php } else { ?>
                                        <td><?php
                                            if ($lowerfieldname == 'hargajual' || $lowerfieldname == 'hargabeli') {
                                ...
                                <?php if ($visibilityMenu['ItemEdit'] || $visibilityMenu['ItemDelete']) { ?>
                                    ...
                                    <?php if ($visibilityMenu['ItemEdit']) { ?>
                                        <a href="<?= base_url('produk/itemform?id=' . urlencode($id) . '&outlet=' . $selected_outlet); ?>"
