                    ...
                    <div class="page-breadcrumb-info">
                        ...
                        <form class="form-horizontal">
                            <?php if (getLoggedInNamaPerusahaan() != "Individual") { ?>
                                ...
                                <div class="col-md-6">
                                    <a href="<?= base_url('produk/index?outlet=' . $selected_outlet); ?>"
            ...
            <div class="box-widget widget-module">
                ...
                <div class="widget-container">
                    <div class=" widget-block">
                        <form class="form-horizontal" method="post" action="<?= base_url('produk'); ?>"
                            ...
                            <?php } ?>
                                ...
                                <div class="table-responsive" style="background-color:#ededed;display: none;"
                                    ...
                                    <p style="text-align: center;padding:5px;" id="label-bahan">Bahan yang dibutuhkan
                                        ...
                                        membuat 1 pcs
                                        :</p>
                                    <table style="margin: 0 auto" id="grid-tambah-bahan" cellpadding="50" cellspacing="50">
                                        <tr>
                                            <td>Bahan</td>
                                            <td>Qty</td>
                                            <td>Satuan</td>
                                        ...
                                        <?php } else {
                                            foreach ($form['bahans'] as $bahan) { 
												...
												$bahanPurchasePrice = $bahan->PurchasePrice;
                                                $bahanDetailID = $bahan->DetailID;
												$total = $bahanPurchasePrice * $bahanQty;
												$totalhpp+= $total;
                                                ?>
                                                ...
                                                <tr class="itembahan">
                                                    ...
                                                    <td><input data-name="qty" type="number" class="form-control qty"
                                                               min="0"
                                                               onkeypress="return ((event.charCode >= 48 && event.charCode <= 57)||(event.keyCode == 8 ||event.keyCode == 46))"
                                                               value="<?= $bahanQty; ?>"/></td>
                                                    ...
                                                    <td><input data-name="hargabeli" type="number" class="form-control hargabeli"
                                                               min="0"
															   value="<?= $bahanPurchasePrice?>"
                                                               onkeypress="return ((event.charCode >= 48 && event.charCode <= 57)||(event.keyCode == 8 ||event.keyCode == 46))"/>
													</td>
													<td><input data-name="total" readonly type="number" class="form-control"
														   min="0"
														   value="<?= $total; ?>"
														   onkeypress="return ((event.charCode >= 48 && event.charCode <= 57)||(event.keyCode == 8 ||event.keyCode == 46))"/></td>														   
                                                    <td>
                                        ...
                                        <?php } ?>
                                        <tr id="row-tambah">
                                            <td colspan="4" align="center"><a href="#" id="tambah-baris-bahan" class="btn btn-xs btn-primary">Tambah Baris</a></td>
