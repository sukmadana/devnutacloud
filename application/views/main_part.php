...
if (strtolower(trim($uris[0])) != 'perusahaan') {
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function ($) {
                ...
                "buttons": [
                    {
                        extend: 'collection', 
                        text: 'Print',
                        className: "btn btn-ghost-default",
                        buttons: 'print'
                    },
                    {
                        extend: 'collection',
                        text: 'Export >',
                        className: "btn btn-ghost-default ml-5",
                        buttons: [
                            'copy',
                            'excel',
                            'csv',
            ...
            table.buttons().container().appendTo( '#tableAction' )
            $("#searchbox").html($(".dataTables_filter"));

            $('#grandTotal').text($('#grandTotalText').text());
