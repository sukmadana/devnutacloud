            ...
            <div class="widget-container">
                <div class=" widget-block">
                    ...
                    <form class="form-horizontal" id="Form" method="post"
                          action="<?= base_url('uang_keluar/simpanData'); ?>"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-6">
                                        <select class="form-control" name="ambilDari" id="list-satuan">
                                            <?php foreach ($mastercashbank as $c) {
                                                $id = $c->AccountID;
                                                $name = $c->AccountName;
                                                ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="radio">
                                    ...
                                    <label>
                                        <input type="radio" name="optionsJenis" id="optionsRadios1" value="Non Biaya">
                                        Non Biaya
                                    </label>
                                </div>
                            </div>
