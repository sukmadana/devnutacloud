                    ...
                    <div class="page-breadcrumb-info">
                        ...
                        <form class="form-horizontal">
                            <?php if (getLoggedInNamaPerusahaan() != "Individual") { ?>
                                ...
                                <div class="col-md-6">
                                    <a href="<?= base_url('supplier/index'); ?>" class="btn btn-default">Kembali</a>
                                </div>
                                <div class="col-md-6">
                        ...
                        <form class="form-horizontal" method="post" action="<?= base_url('supplier'); ?>" id="form-supplier">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6">
                                            <input type="number" class="form-control" id="txt-telepon"
                                                   value="<?= $form['telepon']; ?>" min="0" max="9" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6">
                                            <input type="text" class="form-control" id="txt-catatan"
                                                   value="<?= $form['catatan']; ?>" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="form-actions">
                                        ...
                                        <a href="<?= base_url('supplier/index');?>"><input type="button" class="btn btn-default" value="Cancel"/></a>
                                    </div>
                                </div>
                            </div>
                        </form>
