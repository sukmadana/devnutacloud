<div class="row">
    <br/>
    <div class="col-md-12">
        <a href="<?= base_url() ?>stokmasuk/?outlet=<?= $koreksi_stok->DeviceID; ?>&ds=<?= $date_start ?>&de=<?= $date_end ?>" class="btn btn-default">Kembali</a>
        <?php if ($visibilityMenu['StockEdit']) { ?>
        <a class="btn btn-default pull-right"
           href="<?= base_url() ?>stokmasuk/edit/<?= $koreksi_stok->DeviceID; ?>/<?= $koreksi_stok->TransactionID . "." . $koreksi_stok->DeviceNo ?>">Edit</a>
        <?php } ?>
    </div>
    <div class="col-md-12">
