...
<div class="row">
    <div class="col-md-6">
        <br/><a href="<?= base_url() ?>koreksistok/?outlet=<?= $koreksi_stok->DeviceID; ?>&ds=<?= $date_start ?>&de=<?= $date_end ?>" class="btn btn-default">Kembali</a>
    </div>
    <div class="col-md-12">
        ...
        <div style="display: none;" id="main-content">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <h4>Edit Transaksi Koreksi Stok</h4>
                ...
                <div class="widget-container">
                    <div class="widget-block">
                        <form class="form-horizontal form-store" method="post"
                              action="<?php echo base_url(); ?>koreksistok/simpan">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    echo $koreksi_stok->StockOpnameDate . " " . $koreksi_stok->StockOpnameTime;
                                    ?>" disabled="disabled">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <table id="dynamic-table" class="table table-bordered" style="min-width: 800px">
                                        <thead>
                                        <tr>
                                            <th>Item</th>
                                            <th style="min-width: 160px">Qty Item (Sistem)</th>
                                            <th style="min-width: 160px">Qty Item (Aktual)</th>
                                            <th style="min-width: 160px">Selisih Qty Item</th>
                                                ...
                                                <td>
                                                    <div class="input-group input-value">
                                                        <input type="number" value=""
                                                               name="qty-sistem[]" class="form-control" readonly/>
                                                        <div class="input-group-addon satuan-sistem">...</div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-group input-value">
                                                        <input type="number" step=".0001" name="qty-aktual[]"
                                                        ...
                                                        <?php foreach ($items as $key => $item_data): ?>
                                                            <option
                                                                <?php if ($item->ItemID == $item_data->ItemID && $item->ItemDeviceNo == $item_data->DeviceNo) {
                                                                    ...
                                                                    value="<?= $item_data->ItemID . "." . $item_data->DeviceNo ?>"><?= $item_data->ItemName ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </td>
                                                <td>
                                                    <div class="input-group input-value">
                                                        <input type="number" value="<?= $item->StockByApp ?>"
                                                               name="qty-sistem[]" class="form-control" readonly/>
                                                        <div class="input-group-addon satuan-sistem"><?= $item->Unit; ?></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-group input-value">
                                                        <input type="number" name="qty-aktual[]"
                                                               value="<?= $item->RealStock ?>" class="form-control"/>
                                                        <div class="input-group-addon satuan-aktual"><?= $item->Unit; ?></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-group input-value">
                                    ...
                                    <div class="form-actions text-right">
                                        <a href="<?= base_url() ?>koreksistok/?outlet=<?= $koreksi_stok->DeviceID ?>&ds=<?= $date_start ?>&de=<?= $date_end ?>"
