<div class="row">
    ...
    <div class="col-md-12">
        ...
        <a class="btn btn-default pull-right"
           href="<?= base_url() ?>koreksistok/edit/<?= $koreksi_stok->DeviceID; ?>/<?= $koreksi_stok->TransactionID . "." . $koreksi_stok->DeviceNo ?>">Edit</a>
        <?php } ?>
    </div>
    <div class="col-md-12">
                            ...
                            <div class="col-md-10">
                                <table id="dynamic-table" class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>No</th>
                                        <th>Item</th>
                                        <th>Qty Item (Sistem)</th>
                                        <th>Qty Item (Aktual)</th>
                                        <th>Selisih Qty Item</th>
                                        <th>Keterangan</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    foreach ($item_stok as $key => $item): ?>
                                        ...
                                        <tr>
                                            <td><?= $no ?></td>
                                            <td><?= $item->ItemName ?></td>
                                            <td class="text-center"><?= $item->StockByApp ?></td>
                                            <td class="text-center"><?= $item->RealStock ?></td>
