<div class="row">
    <div class="col-md-6">
        <br/><a href="<?= base_url() ?>koreksistok/?outlet=<?= $_GET['outlet'] ?>&ds=<?= $date_start ?>&de=<?= $date_end ?>"
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                        ...
                                        <tr data-id="1">
                                            <td>
                                                <select data-show-subtext="true" data-live-search="true"
                                                        class="form-control selectpicker" name="item[]" id="pilihitem1"
                                            ...
                                            <td>
                                                <div class="input-group input-value" value="0" data-id="1">
                                                    <input type="number" name="qty-sistem[]" class="form-control"
                                                           readonly/>
                                            ...
                                            <td>
                                                <div class="input-group input-value" value="0" data-id="1">
                                                    <input type="number" step="0.0001" name="qty-aktual[]" class="form-control"/>
                                    ...
                                    <div class="form-actions text-right">
                                        <a href="<?= base_url() ?>koreksistok/?outlet=<?= $_GET['outlet'] ?>&ds=<?= $date_start ?>&de=<?= $date_end ?>"
