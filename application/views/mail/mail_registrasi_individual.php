                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td class="mail_headline"
                                                ...
                                                Hai <b><?=$username;?></b> ! selangkah lagi <br/>untuk mendapatkan akun nutacloud anda
                            ...
                            <tr>
                                <td class="content" style="width: 600px;">
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        ...
                                        <tr>
                                            <td class="full_width_blog" style="width: 600px; font-family: Arial, Helvetica, sans-serif;	font-size: 14px; color: #292929;">
                                                Setelah anda mengkilik tombol konfirmasi, anda dapat masuk ke nutacloud menggunakan
