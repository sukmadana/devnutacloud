                        ...
                        <table cellspacing="0" cellpadding="0" border="0">
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td class="mail_headline"
                                                ...
                                                Hai <b><?=$namaperusahaan;?></b> ! selangkah lagi <br/>untuk mendapatkan ID Perusahaan anda
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td class="main_image" style="width: 600px;">
                                                <img src="<?= base_url(); ?>mail/images/id_perusahaan.png" width="600"
                                        ...
                                        <!--s-->
                                        <tr>
                                            <td class="full_width_blog" height="20" style="width: 600px; font-family: Arial, Helvetica, sans-serif;	font-size: 14px; color: #292929;">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="full_width_blog" style="width: 600px; font-family: Arial, Helvetica, sans-serif;	font-size: 14px; color: #292929;text-align:center" >
                                                Klik tombol konfirmasi dan ikuti panduan cara menggunakan ID Perusahaan.
                            ...
                            <tr>
                                <td class="wrapper">
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td align="center" class="call_to_action_download" style="width: 600px;">
                                                <a href="<?= $url; ?>" class="nodecoration">
                                                    <img src="<?= base_url(); ?>mail/images/download_green.png"
                                                         width="220"
                                                         height="50" style="display: block;" border="0" alt=""/>
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
