                        ...
                        <form class="form-horizontal pull-right">
                            <?php if (getLoggedInNamaPerusahaan() != "Individual") { ?>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-4">
                                         <input type="button" value="Tambah Pilihan Ekstra"
...
<div class="row">
    <div class="col-md-12">
        <div class="box-widget widget-module">
            ...
            <div class="widget-container">
                <div class=" widget-block">
                    <input type="text" placeholder="Cari Pilihan Ekstra" class="form-control"
                           id="search-item"/>
                            ...
                            <tr>
                                ...
                                <?php if ($visibilityMenu['ItemEdit'] || $visibilityMenu['ItemDelete']) { ?>
                                    ...
                                    <?php if ($visibilityMenu['ItemEdit']) { ?>
                                        <a href="<?= base_url('pilihanekstra/itemform?id=' . urlencode($id) . '&outlet=' . $selected_outlet); ?>"
        ...
        <?php $this->load->view('features/dialogs/dialog_hapus_item'); ?>
    </div>
    <?php $this->load->view('features/dialogs/dialog_pilihan_ekstra'); ?>
</div>
