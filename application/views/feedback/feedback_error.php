...
<div class="page-container">
    ...
    <div class="row">
        ...
        <div class="col-md-4 login-container-no-width" style="background-color: #546476">

            <div class="block-content" id="loginperusahaan">
                <div class="aside-tab-content">
                    <h4 style="color:#fff">Terjadi kesalahan dengan pesan : </h4>
                    <ul style="list-style: none;color:#FFF">
                        <?php if ($issubjectempty) { ?>
                            <li> - Perihal harus dipilih minimal satu</li>
                        <?php }
                    ...
                    <a href=" javascript:window.history.go(-1);" style="color:#FFC01D">Perbaiki feedback</a>
                </div>
